...
final class Nodes {
    ...
    static final String BAD_SIZE = "cc.lovezhy.stream.Stream size exceeds max array size";
     ...
     * @return a {@code cc.lovezhy.stream.Node} covering the elements of the input nodes
     ...
     * @return a {@code cc.lovezhy.stream.Node.Builder}
     */
    ...
    /**
     * Produces a variable size @{link cc.lovezhy.stream.Node.Builder}.
     *
     * @param <T> the type of elements of the node builder
     * @return a {@code cc.lovezhy.stream.Node.Builder}
     */
     ...
     * otherwise the exact capacity desired.  A fixed capacity builder will
     * fail if the wrong number of elements are added to the builder.
     * @return a {@code cc.lovezhy.stream.Node.Builder.OfInt}
     */
    ...
    /**
     * Produces a variable size @{link cc.lovezhy.stream.Node.Builder.OfInt}.
     *
     * @return a {@code cc.lovezhy.stream.Node.Builder.OfInt}
     */
     ...
     * otherwise the exact capacity desired.  A fixed capacity builder will
     * fail if the wrong number of elements are added to the builder.
     * @return a {@code cc.lovezhy.stream.Node.Builder.OfLong}
     */
    ...
    /**
     * Produces a variable size @{link cc.lovezhy.stream.Node.Builder.OfLong}.
     *
     * @return a {@code cc.lovezhy.stream.Node.Builder.OfLong}
     */
     ...
     * otherwise the exact capacity desired.  A fixed capacity builder will
     * fail if the wrong number of elements are added to the builder.
     * @return a {@code cc.lovezhy.stream.Node.Builder.OfDouble}
     */
    ...
    /**
     * Produces a variable size @{link cc.lovezhy.stream.Node.Builder.OfDouble}.
     *
     * @return a {@code cc.lovezhy.stream.Node.Builder.OfDouble}
     */
     ...
     * parallel to produce a flat {@code cc.lovezhy.stream.Node} if desired.
     *
     ...
     * elements are collected into a conc-node whose shape mirrors that
     * of the computation. This conc-node can then be flattened in
     * parallel to produce a flat {@code cc.lovezhy.stream.Node.OfInt} if desired.
     *
     ...
     * elements are collected into a conc-node whose shape mirrors that
     * of the computation. This conc-node can then be flattened in
     * parallel to produce a flat {@code cc.lovezhy.stream.Node.OfLong} if desired.
     *
     * @param <P_IN> the type of elements from the source Spliterator
     * @param helper the pipeline helper describing the pipeline
     * @param flattenTree whether a conc node should be flattened into a node
     ...
     * elements are collected into a conc-node whose shape mirrors that
     * of the computation. This conc-node can then be flattened in
     * parallel to produce a flat {@code cc.lovezhy.stream.Node.OfDouble} if desired.
     *
     * @param <P_IN> the type of elements from the source Spliterator
     * @param helper the pipeline helper describing the pipeline
     * @param flattenTree whether a conc node should be flattened into a node
     ...
     * @return a flat {@code cc.lovezhy.stream.Node}
     */
     ...
     *
     * @param node the node to flatten
     * @return a flat {@code cc.lovezhy.stream.Node.OfInt}
     */
     ...
     *
     * @param node the node to flatten
     * @return a flat {@code cc.lovezhy.stream.Node.OfLong}
     */
     ...
     *
     * @param node the node to flatten
     * @return a flat {@code cc.lovezhy.stream.Node.OfDouble}
     */
    ...
    /** cc.lovezhy.stream.Node class for a reference array */
    ...
    /** cc.lovezhy.stream.Node class for a Collection */
    ...
    /**
     * cc.lovezhy.stream.Node class for an internal node with two or more children
     */
    private static abstract class AbstractConcNode<T, T_NODE extends Node<T>> implements Node<T> {
        ...
        AbstractConcNode(T_NODE left, T_NODE right) {
            this.left = left;
            this.right = right;
            // The cc.lovezhy.stream.Node count will be required when the cc.lovezhy.stream.Node spliterator is
    ...
    private static abstract class InternalNodeSpliterator<T,
        ...
        // cc.lovezhy.stream.Node we are pointing to
    ...
    private static abstract class SizedCollectorTask<P_IN, P_OUT, T_SINK extends Sink<P_OUT>,
        ...
        // For cc.lovezhy.stream.Sink implementation
        ...
        public void begin(long size) {
            if (size > length)
                throw new IllegalStateException("size passed to cc.lovezhy.stream.Sink.begin exceeds array length");
