...
/**
 * Factory for instances of a short-circuiting {@code cc.lovezhy.stream.TerminalOp} that implement
...
final class MatchOps {
    ...
    /**
     * Constructs a quantified predicate matcher for a cc.lovezhy.stream.Stream.
     *
     * @param <T> the type of stream elements
     * @param predicate the {@code Predicate} to apply to stream elements
     * @param matchKind the kind of quantified match (all, any, none)
     * @return a {@code cc.lovezhy.stream.TerminalOp} implementing the desired quantified match
     *         criteria
     */
    ...
    /**
     * Constructs a quantified predicate matcher for an {@code cc.lovezhy.stream.IntStream}.
     *
     * @param predicate the {@code Predicate} to apply to stream elements
     * @param matchKind the kind of quantified match (all, any, none)
     * @return a {@code cc.lovezhy.stream.TerminalOp} implementing the desired quantified match
    ...
    /**
     * Constructs a quantified predicate matcher for a {@code cc.lovezhy.stream.LongStream}.
     *
     * @param predicate the {@code Predicate} to apply to stream elements
     * @param matchKind the kind of quantified match (all, any, none)
     * @return a {@code cc.lovezhy.stream.TerminalOp} implementing the desired quantified match
    ...
    /**
     * Constructs a quantified predicate matcher for a {@code cc.lovezhy.stream.DoubleStream}.
     *
     * @param predicate the {@code Predicate} to apply to stream elements
     * @param matchKind the kind of quantified match (all, any, none)
     * @return a {@code cc.lovezhy.stream.TerminalOp} implementing the desired quantified match
    ...
    /**
     * A short-circuiting {@code cc.lovezhy.stream.TerminalOp} that evaluates a predicate on the
    ...
    private static final class MatchOp<T> implements TerminalOp<T, Boolean> {
         ...
         * @param matchKind the kind of quantified match (all, any, none)
         * @param sinkSupplier {@code Supplier} for a {@code cc.lovezhy.stream.Sink} of the
