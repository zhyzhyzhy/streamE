...
final class Streams {
    ...
    static final class RangeIntSpliterator implements Spliterator.OfInt {
         ...
         * side of the range.
         *
         * <p>This is optimized for cases such as cc.lovezhy.stream.IntStream.ints() that is
    ...
    static final class RangeLongSpliterator implements Spliterator.OfLong {
         ...
         * side of the range.
         *
         * <p>This is optimized for cases such as cc.lovezhy.stream.LongStream.longs() that is
