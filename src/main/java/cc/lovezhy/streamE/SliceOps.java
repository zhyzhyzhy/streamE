...
final class SliceOps {
        ...
        return new ReferencePipeline.StatefulOp<T, T>(upstream, StreamShape.REFERENCE,
            ...
            <P_IN> Spliterator<T> opEvaluateParallelLazy(PipelineHelper<T> helper, Spliterator<P_IN> spliterator) {
                ...
                if (size > 0 && spliterator.hasCharacteristics(Spliterator.SUBSIZED)) {
                    ...
                    // @@@ OOMEs will occur for cc.lovezhy.stream.LongStream.longs().filter(i -> true).limit(n)
    ...
    /**
     * Appends a "slice" operation to the provided cc.lovezhy.stream.IntStream.  The slice
     * operation may be may be skip-only, limit-only, or skip-and-limit.
     *
     * @param upstream An cc.lovezhy.stream.IntStream
     * @param skip The number of elements to skip.  Must be >= 0.
     * @param limit The maximum size of the resulting stream, or -1 if no limit
     *        is to be imposed
     */
    ...
    /**
     * Appends a "slice" operation to the provided cc.lovezhy.stream.LongStream.  The slice
     * operation may be may be skip-only, limit-only, or skip-and-limit.
     *
     * @param upstream A cc.lovezhy.stream.LongStream
     * @param skip The number of elements to skip.  Must be >= 0.
     * @param limit The maximum size of the resulting stream, or -1 if no limit
     *        is to be imposed
     */
    ...
    /**
     * Appends a "slice" operation to the provided cc.lovezhy.stream.DoubleStream.  The slice
     * operation may be may be skip-only, limit-only, or skip-and-limit.
     *
     * @param upstream A cc.lovezhy.stream.DoubleStream
     * @param skip The number of elements to skip.  Must be >= 0.
     * @param limit The maximum size of the resulting stream, or -1 if no limit
     *        is to be imposed
     */
