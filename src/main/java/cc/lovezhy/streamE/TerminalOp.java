 ...
 * a result or side-effect.  A {@code cc.lovezhy.stream.TerminalOp} has an input type and stream
 * shape, and a result type.  A {@code cc.lovezhy.stream.TerminalOp} also has a set of
 ...
 * {@link StreamOpFlag}).
 *
 * <p>A {@code cc.lovezhy.stream.TerminalOp} must provide a sequential and parallel implementation
...
interface TerminalOp<E_IN, R> {
     ...
     *
     * @implSpec The default returns {@code cc.lovezhy.stream.StreamShape.REFERENCE}.
     *
     * @return cc.lovezhy.stream.StreamShape of the input type of this operation
     */
     ...
     * using the specified {@code cc.lovezhy.stream.PipelineHelper}.
     *
    ...
    default <P_IN> R evaluateParallel(PipelineHelper<E_IN> helper,
        ...
        if (Tripwire.ENABLED)
            Tripwire.trip(getClass(), "{0} triggering cc.lovezhy.stream.TerminalOp.evaluateParallel serial default");
