 ...
 * type {@code T}.
 *
 * <p>A {@code cc.lovezhy.stream.Node} contains a fixed number of elements, which can be accessed
 * via the {@link #count}, {@link #spliterator}, {@link #forEach},
 * {@link #asArray}, or {@link #copyInto} methods.  A {@code cc.lovezhy.stream.Node} may have zero
 * or more child {@code cc.lovezhy.stream.Node}s; if it has no children (accessed via
 ...
 *
 * @apiNote
 * <p>A {@code cc.lovezhy.stream.Node} typically does not store the elements directly, but instead
 ...
 * {@code cc.lovezhy.stream.Node}s.  Commonly {@code cc.lovezhy.stream.Node}s are formed into a tree whose shape
 * corresponds to the computation tree that produced the elements that are
 * contained in the leaf nodes.  The use of {@code cc.lovezhy.stream.Node} within the stream
...
interface Node<T> {
     ...
     * order if the source for the {@code cc.lovezhy.stream.Node} has a defined encounter order.
     *
     * @param consumer a {@code Consumer} that is to be invoked with each
     *        element in this {@code cc.lovezhy.stream.Node}
     */
    ...
    /**
     * Retrieves the child {@code cc.lovezhy.stream.Node} at a given index.
     *
     ...
     *        array type
     * @return an array containing the contents of this {@code cc.lovezhy.stream.Node}
     */
    T[] asArray(IntFunction<T[]> generator);

    /**
     * Copies the content of this {@code cc.lovezhy.stream.Node} into an array, starting at a
    ...
    /**
     * Gets the {@code cc.lovezhy.stream.StreamShape} associated with this {@code cc.lovezhy.stream.Node}.
     *
     * @implSpec The default in {@code cc.lovezhy.stream.Node} returns
     * {@code cc.lovezhy.stream.StreamShape.REFERENCE}
     *
    ...
    /**
     * A mutable builder for a {@code cc.lovezhy.stream.Node} that implements {@link Sink}, which
    ...
    interface Builder<T> extends Sink<T> {
         ...
         *
         * @return the resulting {@code cc.lovezhy.stream.Node}
         */
        Node<T> build();

        /**
         * Specialized @{code cc.lovezhy.stream.Node.Builder} for int elements
         */
        ...
        /**
         * Specialized @{code cc.lovezhy.stream.Node.Builder} for long elements
         */
        ...
        /**
         * Specialized @{code cc.lovezhy.stream.Node.Builder} for double elements
         */
    ...
    public interface OfPrimitive<T, T_CONS, T_ARR,
         ...
         *        element in this {@code cc.lovezhy.stream.Node.OfPrimitive}
         */
        ...
        default T[] asArray(IntFunction<T[]> generator) {
            if (Tripwire.ENABLED)
                Tripwire.trip(getClass(), "{0} calling cc.lovezhy.stream.Node.OfPrimitive.asArray");
        ...
        /**
         * Copies the content of this {@code cc.lovezhy.stream.Node} into a primitive array,
    ...
    /**
     * Specialized {@code cc.lovezhy.stream.Node} for int elements
     */
    interface OfInt extends OfPrimitive<Integer, IntConsumer, int[], Spliterator.OfInt, OfInt> {
         ...
         *
         * @param consumer a {@code Consumer} that is to be invoked with each
         *        element in this {@code cc.lovezhy.stream.Node}.  If this is an
        ...
        default void forEach(Consumer<? super Integer> consumer) {
            if (consumer instanceof IntConsumer) {
                ...
                if (Tripwire.ENABLED)
                    Tripwire.trip(getClass(), "{0} calling cc.lovezhy.stream.Node.OfInt.forEachRemaining(Consumer)");
        ...
        default void copyInto(Integer[] boxed, int offset) {
            if (Tripwire.ENABLED)
                Tripwire.trip(getClass(), "{0} calling cc.lovezhy.stream.Node.OfInt.copyInto(Integer[], int)");
        ...
        /**
         * {@inheritDoc}
         * @implSpec The default in {@code cc.lovezhy.stream.Node.OfInt} returns
         * {@code cc.lovezhy.stream.StreamShape.INT_VALUE}
         */
        default StreamShape getShape() {
    ...
    /**
     * Specialized {@code cc.lovezhy.stream.Node} for long elements
     */
    interface OfLong extends OfPrimitive<Long, LongConsumer, long[], Spliterator.OfLong, OfLong> {
        ...
        default void forEach(Consumer<? super Long> consumer) {
            if (consumer instanceof LongConsumer) {
                ...
                if (Tripwire.ENABLED)
                    Tripwire.trip(getClass(), "{0} calling cc.lovezhy.stream.Node.OfLong.forEachRemaining(Consumer)");
                spliterator().forEachRemaining(consumer);
            }
        }
        ...
        default void copyInto(Long[] boxed, int offset) {
            if (Tripwire.ENABLED)
                Tripwire.trip(getClass(), "{0} calling cc.lovezhy.stream.Node.OfInt.copyInto(Long[], int)");
        ...
        /**
         * {@inheritDoc}
         * @implSpec The default in {@code cc.lovezhy.stream.Node.OfLong} returns
         * {@code cc.lovezhy.stream.StreamShape.LONG_VALUE}
         */
        default StreamShape getShape() {
    ...
    /**
     * Specialized {@code cc.lovezhy.stream.Node} for double elements
     */
    interface OfDouble extends OfPrimitive<Double, DoubleConsumer, double[], Spliterator.OfDouble, OfDouble> {
        ...
        default void copyInto(Double[] boxed, int offset) {
            if (Tripwire.ENABLED)
                Tripwire.trip(getClass(), "{0} calling cc.lovezhy.stream.Node.OfDouble.copyInto(Double[], int)");
         ...
         * {@inheritDoc}
         *
         * @implSpec The default in {@code cc.lovezhy.stream.Node.OfDouble} returns
         * {@code cc.lovezhy.stream.StreamShape.DOUBLE_VALUE}
         */
        default StreamShape getShape() {
