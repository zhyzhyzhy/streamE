...
public interface DoubleStream extends BaseStream<Double, DoubleStream> {
     ...
     *               {@code cc.lovezhy.stream.DoubleStream} of new values
     * @return the new stream
     ...
     * <pre>{@code
     *     cc.lovezhy.stream.DoubleStream.of(1, 2, 3, 4)
     *         .filter(e -> e > 2)
    ...
    /**
     * Returns a builder for a {@code cc.lovezhy.stream.DoubleStream}.
     *
    ...
    /**
     * Returns an empty sequential {@code cc.lovezhy.stream.DoubleStream}.
     *
    ...
    /**
     * Returns a sequential {@code cc.lovezhy.stream.DoubleStream} containing a single element.
     *
    ...
    public static DoubleStream of(double... values) {
        return StreamSupport.doubleStream(Arrays.spliterator(values, 0, values.length), false);
    }

    /**
     * Returns an infinite sequential ordered {@code cc.lovezhy.stream.DoubleStream} produced by iterative
     * application of a function {@code f} to an initial element {@code seed},
     * producing a {@code cc.lovezhy.stream.Stream} consisting of {@code seed}, {@code f(seed)},
     * {@code f(f(seed))}, etc.
     *
     * <p>The first element (position {@code 0}) in the {@code cc.lovezhy.stream.DoubleStream}
     ...
     *          a new element
     * @return a new sequential {@code cc.lovezhy.stream.DoubleStream}
     */
     ...
     * @return a new infinite sequential unordered {@code cc.lovezhy.stream.DoubleStream}
     */
    ...
    /**
     * A mutable builder for a {@code cc.lovezhy.stream.DoubleStream}.
     *
