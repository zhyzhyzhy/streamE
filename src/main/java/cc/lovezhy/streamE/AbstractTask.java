...
abstract class AbstractTask<P_IN, P_OUT, R,
     ...
     *
     * @param helper The {@code cc.lovezhy.stream.PipelineHelper} describing the stream pipeline
     ...
     * the cc.lovezhy.stream.AbstractTask(T, Spliterator) constructor with the receiver and the
