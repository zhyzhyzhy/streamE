 ...
 *
 * <p>
 * cc.lovezhy.stream.Stream flags may be used to describe characteristics of several different
 ...
 *   <tbody>
 *      <tr>
 *        <th colspan="2" class="tableSubHeadingColor">cc.lovezhy.stream.Stream source</th>
 *        <td>Y</td>
 *        <td>Y</td>
 *        <td>Y</td>
 *        <td>Y</td>
 ...
 * means "not valid".
 *
 * <p>cc.lovezhy.stream.Stream flags are represented by unioned bit sets, so that a single word
 ...
 * flag bits are combined into an {@code int} bit set.  <em>cc.lovezhy.stream.Stream flags</em>
 ...
 * <pre> {@code
 *     Spliterator s = ...;
 *     cc.lovezhy.stream.Stream stream = cc.lovezhy.stream.Streams.stream(s);
