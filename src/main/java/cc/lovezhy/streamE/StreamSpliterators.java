...
class StreamSpliterators {
    ...
    private static abstract class AbstractWrappingSpliterator<P_IN, P_OUT,
        ...
        /**
         * cc.lovezhy.stream.Sink chain for the downstream stages of the pipeline, ultimately
     ...
     * collected to a {@code cc.lovezhy.stream.Node}. It is the order of the pipeline stage
    ...
    // @@@ Consolidate with cc.lovezhy.stream.Node.Builder
