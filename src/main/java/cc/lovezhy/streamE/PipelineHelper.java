 ...
 *
 * <p>
 * A {@code cc.lovezhy.stream.PipelineHelper} describes the initial segment of a stream pipeline,
 ...
 * {@code cc.lovezhy.stream.PipelineHelper}. The {@code cc.lovezhy.stream.PipelineHelper} is passed to the
 ...
 * {@code cc.lovezhy.stream.PipelineHelper} to access information about the pipeline such as
...
abstract class PipelineHelper<P_OUT> {
     ...
     * applying the pipeline stages described by this {@code cc.lovezhy.stream.PipelineHelper} to
    ...
    /**
     * Applies the pipeline stages described by this {@code cc.lovezhy.stream.PipelineHelper} to
     ...
     * }</pre>
     *
     * @param sink the {@code cc.lovezhy.stream.Sink} to receive the results
     ...
     * {@code cc.lovezhy.stream.Sink}.  If the stream pipeline is known to have short-circuiting
     ...
     *
     * @implSpec
     * This method conforms to the {@code cc.lovezhy.stream.Sink} protocol of calling
     * {@code cc.lovezhy.stream.Sink.begin} before pushing elements, via {@code cc.lovezhy.stream.Sink.accept}, and
     * calling {@code cc.lovezhy.stream.Sink.end} after all elements have been pushed.
     *
     * @param wrappedSink the destination {@code cc.lovezhy.stream.Sink}
    ...
    /**
     * Pushes elements obtained from the {@code Spliterator} into the provided
     * {@code cc.lovezhy.stream.Sink}, checking {@link Sink#cancellationRequested()} after each
     * element, and stopping if cancellation is requested.
     *
     * @implSpec
     * This method conforms to the {@code cc.lovezhy.stream.Sink} protocol of calling
     * {@code cc.lovezhy.stream.Sink.begin} before pushing elements, via {@code cc.lovezhy.stream.Sink.accept}, and
     * calling {@code cc.lovezhy.stream.Sink.end} after all elements have been pushed or if
    ...
    /**
     * Takes a {@code cc.lovezhy.stream.Sink} that accepts elements of the output type of the
     * {@code cc.lovezhy.stream.PipelineHelper}, and wrap it with a {@code cc.lovezhy.stream.Sink} that accepts
     * elements of the input type and implements all the intermediate operations
     * described by this {@code cc.lovezhy.stream.PipelineHelper}, delivering the result into the
     * provided {@code cc.lovezhy.stream.Sink}.
     *
     * @param sink the {@code cc.lovezhy.stream.Sink} to receive the results
     * @return a {@code cc.lovezhy.stream.Sink} that implements the pipeline stages and sends
     *         results to the provided {@code cc.lovezhy.stream.Sink}
     */
    ...
    /**
     * Constructs a @{link cc.lovezhy.stream.Node.Builder} compatible with the output shape of
     * this {@code cc.lovezhy.stream.PipelineHelper}.
     *
     ...
     * @return a {@code cc.lovezhy.stream.Node.Builder} compatible with the output shape of this
     *         {@code cc.lovezhy.stream.PipelineHelper}
     */
     ...
     * to the source {@code Spliterator} into a {@code cc.lovezhy.stream.Node}.
     *
     * @implNote
     * If the pipeline has no intermediate operations and the source is backed
     * by a {@code cc.lovezhy.stream.Node} then that {@code cc.lovezhy.stream.Node} will be returned (or flattened
     ...
     *        {@code cc.lovezhy.stream.Node} returned will contain no children, otherwise the
     *        {@code cc.lovezhy.stream.Node} may represent the root in a tree that reflects the
     *        shape of the computation tree.
     * @param generator a factory function for array instances
     * @return the {@code cc.lovezhy.stream.Node} containing all output elements
     */
