 ...
 * {@code cc.lovezhy.stream.Sink} for the first time, you must first call the {@code begin()}
 ...
 * {@code accept()} without again calling {@code begin()}.  {@code cc.lovezhy.stream.Sink} also
 ...
 *
 * <p>A {@code cc.lovezhy.stream.Sink} instance is used to represent each stage of this pipeline,
 * whether the stage accepts objects, ints, longs, or doubles.  cc.lovezhy.stream.Sink has entry
 ...
 * point to the pipeline is the {@code cc.lovezhy.stream.Sink} for the filtering stage, which
 * sends some elements "downstream" -- into the {@code cc.lovezhy.stream.Sink} for the mapping
 * stage, which in turn sends integral values downstream into the {@code cc.lovezhy.stream.Sink}
 * for the reduction stage. The {@code cc.lovezhy.stream.Sink} implementations associated with a
 * given stage is expected to know the data type for the next stage, and call
 * the correct {@code accept} method on its downstream {@code cc.lovezhy.stream.Sink}.  Similarly,
 ...
 * {@code cc.lovezhy.stream.Sink.OfInt}, but also maintain a {@code downstream} field which
 * represents the downstream {@code cc.lovezhy.stream.Sink}, and implement the methods
 * {@code begin()}, {@code end()}, and {@code cancellationRequested()} to
 * delegate to the downstream {@code cc.lovezhy.stream.Sink}.  Most implementations of
 ...
 *
 * <pre>{@code
 *     IntSink is = new cc.lovezhy.stream.Sink.ChainedReference<U>(sink) {
 ...
 * }</pre>
 *
 * <p>Here, we implement {@code cc.lovezhy.stream.Sink.ChainedReference<U>}, meaning that we expect
 ...
 * {@code int} and passes the resulting value to the downstream {@code cc.lovezhy.stream.Sink}.
 *
...
interface Sink<T> extends Consumer<T> {
    ...
    /**
     * Indicates that all elements have been pushed.  If the {@code cc.lovezhy.stream.Sink} is
    ...
    /**
     * Indicates that this {@code cc.lovezhy.stream.Sink} does not wish to receive any more data.
     *
    ...
    /**
     * {@code cc.lovezhy.stream.Sink} that implements {@code cc.lovezhy.stream.Sink<Integer>}, re-abstracts
    ...
    interface OfInt extends Sink<Integer>, IntConsumer {
        ...
        default void accept(Integer i) {
            if (Tripwire.ENABLED)
                Tripwire.trip(getClass(), "{0} calling cc.lovezhy.stream.Sink.OfInt.accept(Integer)");
            accept(i.intValue());
        }
    }

    /**
     * {@code cc.lovezhy.stream.Sink} that implements {@code cc.lovezhy.stream.Sink<Long>}, re-abstracts
    ...
    interface OfLong extends Sink<Long>, LongConsumer {
        ...
        default void accept(Long i) {
            if (Tripwire.ENABLED)
                Tripwire.trip(getClass(), "{0} calling cc.lovezhy.stream.Sink.OfLong.accept(Long)");
            accept(i.longValue());
        }
    }

    /**
     * {@code cc.lovezhy.stream.Sink} that implements {@code cc.lovezhy.stream.Sink<Double>}, re-abstracts
    ...
    interface OfDouble extends Sink<Double>, DoubleConsumer {
        ...
        default void accept(Double i) {
            if (Tripwire.ENABLED)
                Tripwire.trip(getClass(), "{0} calling cc.lovezhy.stream.Sink.OfDouble.accept(Double)");
            accept(i.doubleValue());
        }
    }

    /**
     * Abstract {@code cc.lovezhy.stream.Sink} implementation for creating chains of
     * sinks.  The {@code begin}, {@code end}, and
     * {@code cancellationRequested} methods are wired to chain to the
     * downstream {@code cc.lovezhy.stream.Sink}.  This implementation takes a downstream
     * {@code cc.lovezhy.stream.Sink} of unknown input shape and produces a {@code cc.lovezhy.stream.Sink<T>}.  The
     * implementation of the {@code accept()} method must call the correct
     * {@code accept()} method on the downstream {@code cc.lovezhy.stream.Sink}.
     */
    ...
    /**
     * Abstract {@code cc.lovezhy.stream.Sink} implementation designed for creating chains of
     * sinks.  The {@code begin}, {@code end}, and
     * {@code cancellationRequested} methods are wired to chain to the
     * downstream {@code cc.lovezhy.stream.Sink}.  This implementation takes a downstream
     * {@code cc.lovezhy.stream.Sink} of unknown input shape and produces a {@code cc.lovezhy.stream.Sink.OfInt}.
     ...
     * {@code cancellationRequested} methods are wired to chain to the
     * downstream {@code cc.lovezhy.stream.Sink}.  This implementation takes a downstream
     * {@code cc.lovezhy.stream.Sink} of unknown input shape and produces a {@code cc.lovezhy.stream.Sink.OfLong}.
     * The implementation of the {@code accept()} method must call the correct
     * {@code accept()} method on the downstream {@code cc.lovezhy.stream.Sink}.
     */
     ...
     * {@code cancellationRequested} methods are wired to chain to the
     * downstream {@code cc.lovezhy.stream.Sink}.  This implementation takes a downstream
     * {@code cc.lovezhy.stream.Sink} of unknown input shape and produces a {@code cc.lovezhy.stream.Sink.OfDouble}.
     * The implementation of the {@code accept()} method must call the correct
     * {@code accept()} method on the downstream {@code cc.lovezhy.stream.Sink}.
     */
