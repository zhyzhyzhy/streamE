 ...
 * (e.g., {@code REFERENCE} corresponds to {@code cc.lovezhy.stream.Stream}, {@code INT_VALUE}
 * corresponds to {@code cc.lovezhy.stream.IntStream}).  Each may also correspond to
...
enum StreamShape {
    /**
     * The shape specialization corresponding to {@code cc.lovezhy.stream.Stream} and elements
     * that are object references.
     */
    REFERENCE,
    /**
     * The shape specialization corresponding to {@code cc.lovezhy.stream.IntStream} and elements
     * that are {@code int} values.
     */
    INT_VALUE,
    /**
     * The shape specialization corresponding to {@code cc.lovezhy.stream.LongStream} and elements
     * that are {@code long} values.
     */
    LONG_VALUE,
    /**
     * The shape specialization corresponding to {@code cc.lovezhy.stream.DoubleStream} and
