...
abstract class ReferencePipeline<P_IN, P_OUT>
    ...
    // cc.lovezhy.stream.Stream

    // Stateless intermediate operations from cc.lovezhy.stream.Stream
    ...
    @Override
    public Stream<P_OUT> prepare(String tag, int size, Function<List<P_OUT>, Map<?, ?>> function) {
        return new ReferencePipeline.StatelessOp<P_OUT, P_OUT>(this, StreamShape.REFERENCE,
                StreamOpFlag.NOT_SIZED) {

            private List<P_OUT> list;
            @Override
            Sink<P_OUT> opWrapSink(int flags, Sink<P_OUT> sink) {
                return new Sink.ChainedReference<P_OUT, P_OUT>(sink) {
                    @Override
                    public void begin(long size) {
                        list = new ArrayList<P_OUT>((int) size);
                    }

                    @Override
                    public void end() {
                        StreamContext.reset(ReferencePipeline.this);
                        ReferencePipeline.this.setPrepareDataMap(tag, function.apply(list));
                        downstream.begin(list.size());
                        for (P_OUT p_out : list) {
    ...
    // Stateful intermediate operations from cc.lovezhy.stream.Stream
    ...
    // Terminal operations from cc.lovezhy.stream.Stream
    ...
    /**
     * Source stage of a cc.lovezhy.stream.ReferencePipeline.
     *
    ...
    static class Head<E_IN, E_OUT> extends ReferencePipeline<E_IN, E_OUT> {
        /**
         * Constructor for the source stage of a cc.lovezhy.stream.Stream.
         *
    ...
    /**
     * Base class for a stateless intermediate stage of a cc.lovezhy.stream.Stream.
     *
     * @param <E_IN>  type of elements in the upstream source
     * @param <E_OUT> type of elements in produced by this stage
     * @since 1.8
    ...
    abstract static class StatelessOp<E_IN, E_OUT>
        ...
        /**
         * Construct a new cc.lovezhy.stream.Stream by appending a stateless intermediate
    ...
    /**
     * Base class for a stateful intermediate stage of a cc.lovezhy.stream.Stream.
     *
     * @param <E_IN>  type of elements in the upstream source
     * @param <E_OUT> type of elements in produced by this stage
     * @since 1.8
    ...
    abstract static class StatefulOp<E_IN, E_OUT>
            extends ReferencePipeline<E_IN, E_OUT> {
        /**
         * Construct a new cc.lovezhy.stream.Stream by appending a stateful intermediate operation
