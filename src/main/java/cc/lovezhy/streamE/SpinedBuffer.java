...
class SpinedBuffer<E>
    ...
    public String toString() {
        ...
        forEach(list::add);
        return "cc.lovezhy.stream.SpinedBuffer:" + list.toString();
    }
    ...
    static class OfInt extends SpinedBuffer.OfPrimitive<Integer, int[], IntConsumer>
        ...
        public void forEach(Consumer<? super Integer> consumer) {
            if (consumer instanceof IntConsumer) {
                ...
                if (Tripwire.ENABLED)
                    Tripwire.trip(getClass(), "{0} calling cc.lovezhy.stream.SpinedBuffer.OfInt.forEach(Consumer)");
    ...
    static class OfLong extends SpinedBuffer.OfPrimitive<Long, long[], LongConsumer>
        ...
        public void forEach(Consumer<? super Long> consumer) {
            if (consumer instanceof LongConsumer) {
                ...
                if (Tripwire.ENABLED)
                    Tripwire.trip(getClass(), "{0} calling cc.lovezhy.stream.SpinedBuffer.OfLong.forEach(Consumer)");
                spliterator().forEachRemaining(consumer);
            }
        }
    ...
    static class OfDouble
        ...
        public void forEach(Consumer<? super Double> consumer) {
            if (consumer instanceof DoubleConsumer) {
                ...
                if (Tripwire.ENABLED)
                    Tripwire.trip(getClass(), "{0} calling cc.lovezhy.stream.SpinedBuffer.OfDouble.forEach(Consumer)");
                spliterator().forEachRemaining(consumer);
            }
        }
