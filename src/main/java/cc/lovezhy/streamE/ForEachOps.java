...
/**
 * Factory for creating instances of {@code cc.lovezhy.stream.TerminalOp} that perform an
...
final class ForEachOps {
    ...
    /**
     * Constructs a {@code cc.lovezhy.stream.TerminalOp} that perform an action for every element
     * of a stream.
     *
     ...
     * @return the {@code cc.lovezhy.stream.TerminalOp} instance
     */
    ...
    /**
     * Constructs a {@code cc.lovezhy.stream.TerminalOp} that perform an action for every element
     * of an {@code cc.lovezhy.stream.IntStream}.
     *
    ...
    /**
     * Constructs a {@code cc.lovezhy.stream.TerminalOp} that perform an action for every element
     * of a {@code cc.lovezhy.stream.LongStream}.
     *
    ...
    /**
     * Constructs a {@code cc.lovezhy.stream.TerminalOp} that perform an action for every element
     * of a {@code cc.lovezhy.stream.DoubleStream}.
     *
    ...
    /**
     * A {@code cc.lovezhy.stream.TerminalOp} that evaluates a stream pipeline and sends the
     * output to itself as a {@code cc.lovezhy.stream.TerminalSink}.  Elements will be sent in
     ...
     * {@code cc.lovezhy.stream.TerminalSink} reference that is an instance of this class.
     *
    ...
    static abstract class ForEachOp<T>
        ...
        // cc.lovezhy.stream.TerminalSink
        ...
        /** Implementation class for {@code cc.lovezhy.stream.IntStream} */
        ...
        /** Implementation class for {@code cc.lovezhy.stream.LongStream} */
        ...
        /** Implementation class for {@code cc.lovezhy.stream.DoubleStream} */
    ...
    static final class ForEachTask<S, T> extends CountedCompleter<Void> {
        ...
        // Similar to cc.lovezhy.stream.AbstractTask but doesn't need to track child tasks
        public void compute() {
    ...
    static final class ForEachOrderedTask<S, T> extends CountedCompleter<Void> {
        ...
        private static <S, T> void doCompute(ForEachOrderedTask<S, T> task) {
            ...
            if (task.getPendingCount() > 0) {
                // Cannot complete just yet so buffer elements into a cc.lovezhy.stream.Node
