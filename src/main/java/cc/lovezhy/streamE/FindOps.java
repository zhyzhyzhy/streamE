...
/**
 * Factory for instances of a short-circuiting {@code cc.lovezhy.stream.TerminalOp} that searches
...
final class FindOps {
    ...
    /**
     * Constructs a {@code cc.lovezhy.stream.TerminalOp} for streams of objects.
     *
     * @param <T> the type of elements of the stream
     * @param mustFindFirst whether the {@code cc.lovezhy.stream.TerminalOp} must produce the
     *        first element in the encounter order
     * @return a {@code cc.lovezhy.stream.TerminalOp} implementing the find operation
     */
    ...
    /**
     * Constructs a {@code cc.lovezhy.stream.TerminalOp} for streams of ints.
     *
     * @param mustFindFirst whether the {@code cc.lovezhy.stream.TerminalOp} must produce the
     *        first element in the encounter order
     * @return a {@code cc.lovezhy.stream.TerminalOp} implementing the find operation
    ...
    /**
     * Constructs a {@code cc.lovezhy.stream.TerminalOp} for streams of longs.
     *
     * @param mustFindFirst whether the {@code cc.lovezhy.stream.TerminalOp} must produce the
     *        first element in the encounter order
     * @return a {@code cc.lovezhy.stream.TerminalOp} implementing the find operation
    ...
    /**
     * A short-circuiting {@code cc.lovezhy.stream.TerminalOp} that searches for an element in a
    ...
    private static final class FindOp<T, O> implements TerminalOp<T, O> {
         ...
         * @param sinkSupplier supplier for a {@code cc.lovezhy.stream.TerminalSink} implementing
    ...
    /**
     * Implementation of @{code cc.lovezhy.stream.TerminalSink} that implements the find
