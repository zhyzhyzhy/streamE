...
/**
 * Factory for creating instances of {@code cc.lovezhy.stream.TerminalOp} that implement
 * reductions.
 *
 * @since 1.8
 */
final class ReduceOps {
    ...
    /**
     * Constructs a {@code cc.lovezhy.stream.TerminalOp} that implements a functional reduce on
     * reference values.
     *
     ...
     *        results
     * @return a {@code cc.lovezhy.stream.TerminalOp} implementing the reduction
     */
    ...
    /**
     * Constructs a {@code cc.lovezhy.stream.TerminalOp} that implements a mutable reduce on
     * reference values.
     *
     * @param <T> the type of the input elements
     * @param <I> the type of the intermediate reduction result
     * @param collector a {@code cc.lovezhy.stream.Collector} defining the reduction
    ...
    /**
     * A type of {@code cc.lovezhy.stream.TerminalSink} that implements an associative reducing
